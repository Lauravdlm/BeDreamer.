<div class="filter-container place-filter-container">
    <form id="place-filter" class="place-filter filter" method="get" action="{{ route('places.index') }}">
        @csrf
        <fieldset>
            <leyend>
            ...
            <div class="form-group-container">
                <div class="form-group-inputs">
                    <div class="form-group">
                        <input type="text" class="form-control" id="city_name" name="city_name" placeholder="Ciudad" minlength="3">
                        <select class="form-control" id="city_select" style="display: none;" name="city_id"></select>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="country_name" name="country_name"
                            placeholder="País" minlength="3">
                        <select class="form-control" id="country_select" style="display: none;"
                            name="country_id"></select>
                    </div>
                </div>
                <a href="{{ route('places.index') }}" class="btn btn-danger"><i
                    class="fi fi-sr-undo"></i>
                </a>
                <button type="submit" class="btn yellow-button">Filtrar</button>
            </div>
        </fieldset>
    </form>
</div>
